...
public class LlmHtmlToMarkdownConverterTests
{
    ...
    public void Convert_NullHtml_ReturnsEmptyString()
    {
        ...
        var converter = new LlmHtmlToMarkdownConverter(llmClient, logger, fallback);
    ...
    [Fact]
    public void Convert_VeryShortHtml_UsesFallback()
    {
        // Arrange
        var llmClient = CreateTestLLMClient();
        var reverseLogger = _serviceProvider.GetRequiredService<ILogger<ReverseMarkdownConverter>>();
        ...
        // Act
        var result = converter.Convert(shortHtml);
    ...
    public void Convert_SimpleHtmlWithRealLLM_ReturnsMarkdown()
    {
        // Arrange
    ...
    [RequiresOpenAIKeyFact]
    public void Convert_ComplexRedditHtmlWithRealLLM_ExtractsMainContent()
    {
        // Arrange
    ...
    [RequiresOpenAIKeyFact]
    public void Convert_HtmlWithNoiseRemoval_ProducesCleanerOutput()
    {
        // Arrange
        ...
        var llmConverter = new LlmHtmlToMarkdownConverter(llmClient, llmLogger, fallback);
        ...
        // Act
        var llmResult = llmConverter.Convert(htmlWithNoise);
        var fallbackResult = fallback.Convert(htmlWithNoise);
